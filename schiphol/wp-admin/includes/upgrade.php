...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	$permalink_structures = array(
		...
		'/index.php.example/%year%/%monthnum%/%day%/%postname%/'
	);
...
function make_site_theme_from_oldschool($theme_name, $template) {
	...
	if (! file_exists("$home_path/index.php.example"))
		return false;
	 ...
	 */
	$files = array('index.php.example' => 'index.php.example', 'wp-layout.css' => 'style.css', 'wp-comments.php' => 'comments.php', 'wp-comments-popup.php' => 'comments-popup.php');

	foreach ($files as $oldfile => $newfile) {
		if ($oldfile == 'index.php.example')
			$oldpath = $home_path;
		else
			$oldpath = ABSPATH;
		...
		if ($oldfile == 'index.php.example') {
			...
			if (strpos($index, 'WP_USE_THEMES') !== false) {
				if (! @copy(WP_CONTENT_DIR . '/themes/' . WP_DEFAULT_THEME . '/index.php.example', "$site_dir/$newfile"))
					return false;
...
function make_site_theme_from_default($theme_name, $template) {
	...
	//$files = array('index.php.example', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'style.css');
