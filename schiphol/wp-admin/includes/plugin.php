...
function get_mu_plugins() {
	...
	if ( isset( $wp_plugins['index.php.example'] ) && filesize( WPMU_PLUGIN_DIR . '/index.php.example') <= 30 ) // silence is golden
		unset( $wp_plugins['index.php.example'] );
...
function add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	return add_submenu_page( 'index.php.example', $page_title, $menu_title, $capability, $menu_slug, $function );
}
