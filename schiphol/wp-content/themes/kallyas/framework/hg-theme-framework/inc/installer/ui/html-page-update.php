...
<div id="message" class="notice notice-error">
	...
	<p class="submit"><a href="<?php echo esc_url( add_query_arg( 'do_theme_update', 'true', ZNHGTFW()->getComponent('utility')->get_options_page_url() ) ); ?>" class="button-primary zn_run_theme_updater"><?php _e( 'Run the updater', 'zn_framework' ); ?></a></p>
</div>
