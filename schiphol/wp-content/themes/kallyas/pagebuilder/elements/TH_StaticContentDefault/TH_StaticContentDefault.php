...
class TH_StaticContentDefault extends ZnElements
{
	...
	function element()
	{
		...
		?>
		<div class="kl-slideshow static-content__slideshow <?php echo implode(' ', $classes); ?> " id="<?php echo esc_attr( $element_id ); ?>">
	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#W-9NdljkYtw') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/static-content-default/') ),
				'copy'    => $uid,
				'general' => true,
				'custom_id' => true,
			)),
