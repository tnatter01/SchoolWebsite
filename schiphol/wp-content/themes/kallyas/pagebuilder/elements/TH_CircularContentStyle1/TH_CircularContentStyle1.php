	...
	function options()
	{
		...
		$options = array (
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#2Q_KC-SrYL4') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/circular-content-style-1/') ),
				'copy'    => $uid,
				'general' => true,
			)),
